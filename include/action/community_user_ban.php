<?php
    ...
    if (language() == 'french')
    {
        ...
        define('ACTION_COMMUNITY_ADMIN_FOUND_YOURSELF', 'Sorry, but you can not edit yourself.');
        define('ACTION_COMMUNITY_ADMIN_FOUND_MODERATOR', 'Sorry, but that user is a moderator of this community.');
    }
    else
    {
        define('ACTION_COMMUNITY_ADMIN_NOT_FOUND_COMMUNITY', 'Sorry, but this community does not exist.');
    ...
    {
        makeCookie('notice', ACTION_COMMUNITY_ADMIN_FOUND_YOURSELF);
        header('Location: ./?s=community_modify&i=' . $communityRow['community_id']);
        die;
    }
    ...
    {
        makeCookie('notice', ACTION_COMMUNITY_ADMIN_FOUND_MODERATOR);
        header('Location: ./?s=community_modify&i=' . $communityRow['community_id']);
        die;
    }

    (new \Databases\CommunityBannedUsers())->banUser($communityRow['community_id'], $userId);
