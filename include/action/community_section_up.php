<?php
    ...
    $communitySectionsRow = (new \Databases\CommunitySections())->findPreviousActiveSectionByOrder($communityRow['community_id'], $communityRow['section_order_id']);
    if ($communitySectionsRow)
    {
        (new \Databases\CommunitySections())->swapOrderIds($communityRow['section_id'], $communityRow['section_order_id'], $communitySectionsRow['section_id'], $communitySectionsRow['section_order_id']);
    }
